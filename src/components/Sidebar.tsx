...
export default function Sidebar({ activeTab, onTabChange }: SidebarProps) {
  ...
  return (
    <div className="w-80 bg-card/50 backdrop-blur-xl border-r border-border/50 h-screen flex flex-col">
      {/* Header */}
      <div className="p-6 border-b border-border/50">
        <div className="flex items-center space-x-3">
          <div className="w-12 h-12 gradient-purple rounded-xl flex items-center justify-center glow-purple">
            <Users className="w-7 h-7 text-white" />
          </div>
          <div>
            <h1 className="text-2xl font-bold gradient-text">MentiBY</h1>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "w-full p-5 rounded-2xl text-left transition-all duration-300 group relative overflow-hidden",
